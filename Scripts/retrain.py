...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='./tensorflow/tf_files/images',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='./tensorflow/tf_files/retrained_graph.pb',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='./tensorflow/tf_files/retrained_labels.txt',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='./tensorflow/tf_files/inception',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='./tensorflow/tf_files/bottlenecks',
